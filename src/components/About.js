        ...
        <div className="container">
            ...
            `}>
                <div className="card-content has-text-centered">
                    ...
                    <p>Coming from a background with no coding experience to working fulltime as a developer has been one of the most challenging and rewarding experiences of my life. Several years ago I never would have pictured myself writing this, let alone writing this on a website that I created. I strive every day to push myself just a little further than the last, and I know I have so much further to go. Despite that, I have learned to embrace the struggle and the endless pursuit of knowledge.</p>
